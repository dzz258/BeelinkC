//
//  DKRegisterStep2ViewController.m
//  BeelinkC
//
...
@interface DKRegisterStep2ViewController ()
...
@implementation DKRegisterStep2ViewController
...
- (void)_addSubviews{
    ...
    if ([kLocal_text(@"language") isEqualToString:@"en"]) {
        [self.title_lineV.layer addSublayer:[UIColor color_shade:CGSizeMake(kWidth_fact(90), kWidth_fact(6)) colors:@[@"#00dac2",@"#fffa18"]]];
    }else{
        [self.title_lineV.layer addSublayer:[UIColor color_shade:CGSizeMake(kWidth_fact(50), kWidth_fact(6)) colors:@[@"#00dac2",@"#fffa18"]]];
    }
...
-(UILabel *)subTitleL{
    if (!_subTitleL) {
        ...
        _subTitleL.text = kLocal_text(@"register_subTitle_step2");
...
-(UIButton *)submitBtn{
    if (!_submitBtn) {
        ...
        [_submitBtn setTitle:kLocal_text(@"register_btn_register") forState:UIControlStateNormal];
...
-(UITextField *)text_1F{
    if (!_text_1F) {
        ...
        NSAttributedString *attrString = [[NSAttributedString alloc] initWithString:kLocal_text(@"register_set_pass_input") attributes:@{NSForegroundColorAttributeName:[UIColor grayColor],NSFontAttributeName:_text_1F.font}];
...
-(UITextField *)text_2F{
    if (!_text_2F) {
        ...
        NSAttributedString *attrString = [[NSAttributedString alloc] initWithString:kLocal_text(@"register_affirm_pass_input") attributes:@{NSForegroundColorAttributeName:[UIColor grayColor],NSFontAttributeName:_text_2F.font}];
