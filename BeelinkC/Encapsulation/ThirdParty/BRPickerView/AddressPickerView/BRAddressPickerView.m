...
- (instancetype)initWithShowType:(BRAddressPickerMode)showType
    ...
    if (self = [super init]) {
        ...
        self.provinceModelArr = [_defaultSelectedArr copy];
        BRProvinceModel *provinceModel = self.selectProvinceModel = self.provinceModelArr.firstObject;
        self.cityModelArr = provinceModel.citylist;
        BRCityModel *cityModel = self.selectCityModel = self.cityModelArr.firstObject;
        self.areaModelArr = cityModel.arealist;
