...
//    label.font = KF_H_F(21);//[UIFont systemFontOfSize:18.0f * kScaleFit];
//    // 字体自适应属性
...
//    }
    ...
    if (self.type == BRStringPickerComponentSingle) {
        ...
        label.frame = CGRectMake(0, 0, self.alertView.frame.size.width / [self.dataSourceArr count], 35.0f * kScaleFit);
        label.text = self.dataSourceArr[component][row];
    }
    return label;
}
